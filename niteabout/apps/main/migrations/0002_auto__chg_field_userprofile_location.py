...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_userprofile', 'location', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'UserProfile.location'
        db.alter_column(u'main_userprofile', 'location', self.gf('django.db.models.fields.TextField')())
