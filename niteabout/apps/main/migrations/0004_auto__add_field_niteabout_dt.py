...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NiteAbout.dt'
        db.add_column(u'main_niteabout', 'dt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NiteAbout.dt'
        db.delete_column(u'main_niteabout', 'dt')
    ...
    models = {
        ...
        u'main.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interested': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
