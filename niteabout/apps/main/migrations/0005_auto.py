...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'main_event_locations')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'main_event_locations'))
    ...
    models = {
        ...
        u'main.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locations': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'new_events'", 'symmetrical': 'False', 'to': u"orm['places.Place']"}),
