...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Place.price'
        db.delete_column(u'places_place', 'price')

        # Deleting field 'Place.volume'
        db.delete_column(u'places_place', 'volume')

        # Deleting field 'Place.dancing'
        db.delete_column(u'places_place', 'dancing')

        # Deleting field 'Place.attire'
        db.delete_column(u'places_place', 'attire')


    def backwards(self, orm):
        # Adding field 'Place.price'
        db.add_column(u'places_place', 'price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'Place.volume'
        db.add_column(u'places_place', 'volume',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'Place.dancing'
        db.add_column(u'places_place', 'dancing',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1, blank=True),
                      keep_default=False)
