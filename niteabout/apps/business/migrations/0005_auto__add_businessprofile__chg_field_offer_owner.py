...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'business_businessprofile', (
        ...
        db.send_create_signal(u'business', ['BusinessProfile'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'business_businessprofile')


        # Changing field 'Offer.owner'
        db.alter_column(u'business_offer', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.BusinessProfile']))
    ...
    models = {
        ...
        u'business.offer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['business.BusinessProfile']"}),
