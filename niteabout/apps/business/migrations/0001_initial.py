...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'business_business', (
            (u'organization_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['organizations.Organization'], unique=True, primary_key=True)),
        ...
        # Adding model 'Offer'
        db.create_table(u'business_offer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organizations.Organization'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('expiration', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 5, 0, 0))),
        ))
        db.send_create_signal(u'business', ['Offer'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'business_offer')
    ...
    models = {
        ...
        u'business.business': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Business', '_ormbases': [u'organizations.Organization']},
        ...
        u'business.offer': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
