...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.owner'
        db.alter_column(u'business_offer', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organizations.Organization']))
        # Deleting field 'BusinessProfile.name'
        db.delete_column(u'business_businessprofile', 'name')


    def backwards(self, orm):

        # Changing field 'Offer.owner'
        db.alter_column(u'business_offer', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['business.BusinessProfile']))

        # User chose to not deal with backwards NULL issues for 'BusinessProfile.name'
        raise RuntimeError("Cannot reverse this migration. 'BusinessProfile.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'BusinessProfile.name'
        db.add_column(u'business_businessprofile', 'name',
    ...
    models = {
        ...
        u'business.businessprofile': {
            'Meta': {'object_name': 'BusinessProfile'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organization': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['organizations.Organization']", 'unique': 'True'}),
            'place': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['places.Place']", 'unique': 'True'})
        },
        u'business.offer': {
            'Meta': {'object_name': 'Offer'},
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['organizations.Organization']"}),
