...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.expiration'
        db.add_column(u'business_offer', 'expiration',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 29, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.expiration'
        db.delete_column(u'business_offer', 'expiration')
    ...
    models = {
        ...
        u'business.offer': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 29, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.BusinessProfile']"}),
